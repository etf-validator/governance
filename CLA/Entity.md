# ETF Entity Contributor License Agreement

Thank you for your interest in contributing to ETF ("We" or "Us").
This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by mail, email or fax, following the instructions at http://gov.etf-validator.net/cla/.
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in https://gov.etf-validator.net/TOR/CONTRIBUTING.html.
...
CC BY-ND for the ETF logo and CC BY for all other Media (including any right to adopt any future version of a license if permitted).
...
(d) You have followed the instructions in https://gov.etf-validator.net/TOR/CONTRIBUTING.html, if You do not own the Copyright in the entire work of authorship Submitted.
...
6.6  You are required to name Us all GitHub usernames of Your organisation working on this project. You agree that files are created with these GitHub usernames in the publicly accessible repository https://github.com/etf-validator/governance, indicating that You have signed this CLA. You are responsible for informing us when a username needs to be added or deleted.

## Us:

Name: European Commission - DG Joint Research Centre
...
Based on the Harmony Entity Contributor License Agreement (HA-CLA-E) 4
